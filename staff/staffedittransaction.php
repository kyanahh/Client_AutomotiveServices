...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($updateStmt->execute()) {
        ...
        header("Location: stafftransactions.php?message=Transaction updated successfully!");
        exit;
    } else {
            ...
            <div class="px-3 pt-4">
                ...
                <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">
                    ...
                    <div class="row mb-3 ms-2 mt-2">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" id="remarks" name="remarks" rows="3" value="<?php echo $remarks ?>"><?php echo htmlspecialchars($remarks); ?></textarea>
                        </div>
                    </div>
